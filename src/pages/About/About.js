    ...
    <div>
      ...
      <div className="container m-auto py-6">
        <div class="flex flex-col md:flex-row bg-white">
          <div class="p-12 flex flex-col justify-center md:w-1/2 2xl:w-full 2xl:p-44">
          ...
          <img class="md:w-1/2 h-52 md:h-auto object-cover" src="https://images.squarespace-cdn.com/content/v1/620e74d7c40768323153fba5/56194fee-7329-4bd6-8ef7-2670db26238d/Roman_6372%2Bcopie.jpg" alt="" />
        </div>
      </div>
